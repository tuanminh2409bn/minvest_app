      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset('assets/images/crown_icon.png', height: 22, width: 22),
              const SizedBox(width: 4),
              Flexible(child: Text(l10n.upgrade, style: const TextStyle(color: Colors.white, fontSize: 12), overflow: TextOverflow.ellipsis)),
            ],
          )
        ],
      ),
